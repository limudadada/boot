...
import com.example.FreedomParam;
...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    @Resource
    private FreedomParam freedomParam;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        System.out.println("加载客户端报文......【" + ctx.channel().id() + "】" + " :" + msg);
        //判断如果是查询
//        freedomReadCardService.beginReadcard("fid","tid",1,ctx);

        /**
         *  下面可以解析数据，保存数据，生成返回报文，将需要返回报文写入write函数
         */
        //响应客户端
        this.channelWrite(ctx.channel().id(), "服务端返回的报文，娃哈哈....."+ctx.channel().id());
    }
